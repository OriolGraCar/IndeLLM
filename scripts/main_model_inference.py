...
def main(args):
    ...
    # Default arguments batch_size = 32, learning_rate = 1e-4, hidden_layer_size = 1028 
    # if model was trained with other arguments those need to be updated
    m = model.Indellm() 
    if disable_tqdm:
        m.disable_tqdm()
    m.run(csv_data, model, plm_name, embedding_path, output_path, output_name)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_name", type=str, defaulr="Predictions", help="Name for the txt file to generate.")
